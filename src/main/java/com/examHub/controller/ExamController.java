...
public class ExamController {
  ...
  //  @ApiOperation(value = "Creating a New  exam")
   ...
   // @ApiOperation(value = "update Exam")
    @RequestMapping(value = RequestMappingConstants.DELETEEXAM, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.PUT)
