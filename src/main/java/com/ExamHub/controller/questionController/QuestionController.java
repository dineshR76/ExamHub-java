...
public class QuestionController {
    ...
    @RequestMapping(value = RequestMappingConstants.UPDATEQUESTION, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.PUT)
    ...
    @RequestMapping(value = RequestMappingConstants.GETALLQUESTION, params = {"page", "size"}, method = RequestMethod.GET)
    ...
    @RequestMapping(value = RequestMappingConstants.GETQUESTIONBYID, params = {"questionId"}, method = RequestMethod.GET)
    ...
    @RequestMapping(value = RequestMappingConstants.DELETEQUESTION, params = {"questionId"}, method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
