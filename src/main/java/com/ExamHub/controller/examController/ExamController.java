package com.ExamHub.controller.examController;

import com.ExamHub.model.Message;
import com.ExamHub.dto.examRequestDto.ExamRequestDto;
...
public class ExamController {
  ...
  //  @ApiOperation(value = "Creating a New  exam")
   ...
   // @ApiOperation(value = "update Exam")
    @RequestMapping(value = RequestMappingConstants.UPDATE_EXAM, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.PUT)
  ...
  //  @ApiOperation(value = "get all Exam")
   ...
   // @ApiOperation(value = "get Exam by id")
    ...
    @RequestMapping(value = RequestMappingConstants.DELETE_EXAM, params = {"examId"}, method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
